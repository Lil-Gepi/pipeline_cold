...
out_bcf="${cold_dir}/data/F50_r16/coldF50_r16_raw.bcf"
...
in_bcf="${cold_dir}/data/F50_r16/coldF50_r16_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/F50_r16/coldF50_r16_pre.bcf"
