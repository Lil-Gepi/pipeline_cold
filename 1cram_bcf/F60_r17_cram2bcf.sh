...
out_bcf="${cold_dir}/data/F60_r17/coldF60_r17_norl_raw.bcf"
...
samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/a/LB_357.D709+D508.cram" |\
...
in_bcf="${cold_dir}/data/F60_r17/coldF60_r17_norl_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/F60_r17/coldF60_r17_norl_pre.bcf"
