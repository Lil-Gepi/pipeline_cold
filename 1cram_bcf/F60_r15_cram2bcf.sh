...
out_bcf="${cold_dir}/data/F60_r15/coldF60_r15_norl_raw.bcf"
...
in_bcf="${cold_dir}/data/F60_r15/coldF60_r15_norl_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/F60_r15/coldF60_r15_norl_pre.bcf"
