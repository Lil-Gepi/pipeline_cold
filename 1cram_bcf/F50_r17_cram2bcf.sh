...
out_bcf="${cold_dir}/data/F50_r17/coldF50_r17_raw.bcf"
...
samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/a/LB_313.D707.cram" |\
...
in_bcf="${cold_dir}/data/F50_r17/coldF50_r17_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/F50_r17/coldF50_r17_pre.bcf"
