...
out_bcf="${cold_dir}/data/coldF10_r11/coldF10_r11_raw.bcf"
...
in_bcf="${cold_dir}/data/coldF10_r11/coldF10_r11_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/coldF10_r11/coldF10_r11_pre.bcf"
