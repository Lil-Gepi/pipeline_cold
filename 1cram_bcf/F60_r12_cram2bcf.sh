...
out_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r12/coldF60_r12_norl_raw.bcf"
...
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/a/LB_329.D708.cram" | ./rupert_pipe_v2/flag-short.awk ) \
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/b/LB_329.D708.cram" | ./rupert_pipe_v2/flag-short.awk ) \
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_2/a/LB_357.D708+D507.cram" | ./rupert_pipe_v2/flag-short.awk )|\
...
in_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r12/coldF60_r12_norl_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r12/coldF60_r12_norl_pre.bcf"
