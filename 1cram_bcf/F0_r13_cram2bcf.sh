...
out_bcf="${cold_dir}/data/coldF0_r13/coldF0_r13_raw.bcf"
...
in_bcf="${cold_dir}/data/coldF0_r13/coldF0_r13_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/coldF0_r13/coldF0_r13_pre.bcf"
