...
out_bcf="${cold_dir}/data/F50_r19/coldF50_r19_raw.bcf"
...
samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/a/LB_313.D709.cram" |\
...
in_bcf="${cold_dir}/data/F50_r19/coldF50_r19_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/F50_r19/coldF50_r19_pre.bcf"
