...
out_bcf="${cold_dir}/data/F60_r19/coldF60_r19_norl_raw.bcf"
...
in_bcf="${cold_dir}/data/F60_r19/coldF60_r19_norl_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/F60_r19/coldF60_r19_norl_pre.bcf"
