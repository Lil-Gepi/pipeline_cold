...
out_bcf="${cold_folder}/data/coldF60_r11/coldF60_r11_raw.bcf"
...
samtools merge -f "$ref_fa" -O SAM -o - "$in_folder_329/a/LB_329.D707.cram" \
...
in_bcf="${cold_folder}/data/coldF60_r11/coldF60_r11_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_folder}/data/coldF60_r11/coldF60_r11_pre.bcf"
