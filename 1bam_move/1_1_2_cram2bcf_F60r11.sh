...
out_bcf="${cold_dir}/data/coldF60_r11/coldF60_r11_piped_raw.bcf"
...
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_329/a/LB_329.D707.cram" | ./rupert_pipe_v2/flag-short.awk -v READ_LENGTH=$rl_329 ) \
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_329/b/LB_329.D707.cram" | ./rupert_pipe_v2/flag-short.awk -v READ_LENGTH=$rl_329 ) \
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_356/a/LB_356.D707+D507.cram" | ./rupert_pipe_v2/flag-short.awk -v READ_LENGTH=$rl_356 )|\
...
in_bcf="${cold_dir}/data/coldF60_r11/coldF60_r11_piped_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/coldF60_r11/coldF60_r11_piped_pre.bcf"
