...
out_bcf="~/COLD/data/coldF60_r11/coldF60_r11_noreadlength_raw.bcf"
...
in_bcf="~/COLD/data/coldF60_r11/coldF60_r11_noreadlength_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="~/COLD/data/coldF60_r11/coldF60_r11_noreadlength_pre.bcf"
