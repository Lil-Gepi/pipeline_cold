...
out_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r11/coldF60_r11_norl_raw.bcf"
...
in_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r11/coldF60_r11_norl_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r11/coldF60_r11_norl_pre.bcf"
