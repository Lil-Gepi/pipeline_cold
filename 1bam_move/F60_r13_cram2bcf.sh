...
out_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r13/coldF60_r13_norl_raw.bcf"
...
in_dir_1="/Volumes/Data/329"
in_dir_2="/Volumes/Data/356"
...
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/a/LB_329.D709.cram" | ./rupert_pipe_v2/flag-short.awk ) \
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_1/b/LB_329.D709.cram" | ./rupert_pipe_v2/flag-short.awk ) \
<(samtools view -T "$ref_fa" -h -F 0x400 "$in_dir_2/a/LB_356.D709+D507.cram" | ./rupert_pipe_v2/flag-short.awk )|\
...
in_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r13/coldF60_r13_norl_raw.bcf"
# output path (use - to write uncompressed BCF to stdout, or leave empty to write VCF to stdout)
out_bcf="${cold_dir}/data/rupert_pipe_data/coldF60_r13/coldF60_r13_norl_pre.bcf"
