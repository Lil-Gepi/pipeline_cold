...
pdf("./Plots/r11_plots/FET_adapted_r11_s1_F0-F30_fdr_adjusted_rising_cmh_highlight.pdf", width = 10, height = 6, compress = F )
ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ggtitle("Adapted chi-square test in r11_s1 contrasting F0 and F30")+
...
axisdf = don %>% group_by(CHR) %>% summarize(center=( max(BPcum) + min(BPcum) ) / 2 )
pdf("FET_adapted_r11_s2_F0-F30_fdr_adjusted_rising_cmh_highlight.pdf", width = 10, height = 6, compress = F )
ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ggtitle("Adapted chi-square test in r11_s2 contrasting F0 and F30")+
  geom_point( aes(color=as.factor(CHR)), alpha=0.8, size=1 ) +
  scale_color_manual(values = rep(c("grey", "black"), 22 )) +
  scale_x_continuous(name = "Chromosome", label = c("X", "2L","2R","3L", "3R", "4"), breaks= axisdf$center ) +
  scale_y_continuous(name = "-log10(q)", expand = c(0, 0) ) +     
...
axisdf = don %>% group_by(CHR) %>% summarize(center=( max(BPcum) + min(BPcum) ) / 2 )
pdf("FET_adapted_r11_s3_F0-F30_fdr_adjusted_rising_cmh_highlight.pdf", width = 10, height = 6, compress = F )
ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ggtitle("Adapted chi-square test in r11_s3 contrasting F0 and F30")+
  geom_point( aes(color=as.factor(CHR)), alpha=0.8, size=1 ) +
  scale_color_manual(values = rep(c("grey", "black"), 22 )) +
  scale_x_continuous(name = "Chromosome", label = c("X", "2L","2R","3L", "3R", "4"), breaks= axisdf$center ) +
  scale_y_continuous(name = "-log10(q)", expand = c(0, 0) ) +     
...
axisdf = don %>% group_by(CHR) %>% summarize(center=( max(BPcum) + min(BPcum) ) / 2 )
pdf("FET_adapted_r11_s4_F0-F30_fdr_adjusted_rising_cmh_highlight.pdf", width = 10, height = 6, compress = F )
ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ggtitle("Adapted chi-square test in r11_s4 contrasting F0 and F30")+
  geom_point( aes(color=as.factor(CHR)), alpha=0.8, size=1 ) +
  scale_color_manual(values = rep(c("grey", "black"), 22 )) +
  scale_x_continuous(name = "Chromosome", label = c("X", "2L","2R","3L", "3R", "4"), breaks= axisdf$center ) +
  scale_y_continuous(name = "-log10(q)", expand = c(0, 0) ) +     
...
axisdf = don %>% group_by(CHR) %>% summarize(center=( max(BPcum) + min(BPcum) ) / 2 )
pdf("FET_adapted_r11_s5_F0-F30_fdr_adjusted_rising_cmh_highlight.pdf", width = 10, height = 6, compress = F )
ggplot(don, aes(x=BPcum, y=-log10(P))) +
  ggtitle("Adapted chi-square test in r11_s5 contrasting F0 and F30")+
  geom_point( aes(color=as.factor(CHR)), alpha=0.8, size=1 ) +
  scale_color_manual(values = rep(c("grey", "black"), 22 )) +
  scale_x_continuous(name = "Chromosome", label = c("X", "2L","2R","3L", "3R", "4"), breaks= axisdf$center ) +
  scale_y_continuous(name = "-log10(q)", expand = c(0, 0) ) +     
